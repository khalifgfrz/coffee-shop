...
import { IOrderQuery } from "../models/order";

const getOrderLink = (req: Request<AppOrderParams, {}, {}, QueryOrderParams>, info?: "previous" | "next"): string => {
  ...
  const serialize = (query: IOrderQuery): string => {
    const str = [];
